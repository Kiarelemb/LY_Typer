...
public class ContractiblePanel extends QRContractiblePanel {
	...
	public static final LCDNumberLabel STANDARD_LEN_LABEL = new LCDNumberLabel();
	...
	public final QRColumnContentPanel standardDataPanel = addColumn("标顶数据", 435);
	...
	private void init_standardDataPanel() {
		...
		StandardCodeLengthBtn viewTypeImageBtn = new StandardCodeLengthBtn();
		...
		separator1.setBounds(15, 95, 220, 20);
		oneLabelTip.setBounds(15, 120, 85, 30);
		oneLabel.setBounds(110, 120, 115, 30);
		twoLabelTip.setBounds(15, 160, 85, 30);
		twoLabel.setBounds(110, 160, 115, 30);
		threeLabelTip.setBounds(15, 200, 85, 30);
		threeLabel.setBounds(110, 200, 115, 30);
		fourLabelTip.setBounds(15, 240, 85, 30);
		fourLabel.setBounds(110, 240, 115, 30);
		separator2.setBounds(15, 275, 220, 20);
		allSpaceLabelTip.setBounds(15, 300, 85, 30);
		allSpaceLabel.setBounds(110, 300, 115, 30);
		leftRightLabelTip.setBounds(15, 340, 85, 30);
		leftRightLabel.setBounds(110, 340, 115, 30);
		viewTypeImageBtn.setBounds(15, 385, 220, 30);
	}
