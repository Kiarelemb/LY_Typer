...
public class TextLoad {
    private static final Logger logger = QRLoggerUtils.getLogger(TextLoad.class);
        ...
        if (threePara || twoPara) {
            ...
            if (!this.isEnglish) {
                ...
                if (!marksContains) {
                    ...
                    logger.info("当前文本为中文" + (this.isChinesePhrase ? "词语" : "单字"));
