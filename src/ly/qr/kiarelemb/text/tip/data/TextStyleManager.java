...
import ly.qr.kiarelemb.data.ColorData;
...
public class TextStyleManager {
	...
	static {
		...
		try {
			...
			QRSwing.setGlobalSetting("simplified.code.one", ColorData.getColor(SIMPLIFIED_ONE));
			QRSwing.setGlobalSetting("simplified.code.two", ColorData.getColor(SIMPLIFIED_TWO));
